  ...
  return (
    <article className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
      <div className={cn("relative", align === "right" && "md:order-2")}>
        ...
        <div
          className={cn(
            "absolute -bottom-5 bg-background border border-border rounded-2xl px-5 py-2 shadow-elegant flex items-center gap-3",
            align === "right" ? "-left-4" : "-right-4"
          )}
        >
          <div className="grid place-items-center h-7 w-7 rounded-full bg-gold text-gold-foreground">
